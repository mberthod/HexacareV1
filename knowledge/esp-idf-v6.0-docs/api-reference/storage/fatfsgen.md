<!-- Source: _sources/api-reference/storage/fatfsgen.rst.txt (ESP-IDF v6.0 documentation) -->

# Generating and Parsing FATFS on Host

This document is intended mainly for developers of Python tools `fatfsgen.py <fatfs/fatfsgen.py>` and `fatfsparse.py <fatfs/fatfsparse.py>`, and people with special interest in these tools and implementation of the FAT file system in ESP-IDF. If you are interested in using these tools, please refer to the user guide at `fatfs-partition-generator`.
...
<figure>
<img src="../../../_static/classes_fatfsgen.svg" class="align-center" alt="../../../_static/classes_fatfsgen.svg" />
<figcaption>FAT File System Generator and Parser Design Architecture</figcaption>
</figure>
...
<figure>
<img src="../../../_static/fat_table.svg" class="align-center" alt="../../../_static/fat_table.svg" />
</figure>
...
<figure>
<img src="../../../_static/tree_fatfs.svg" class="align-center" alt="../../../_static/tree_fatfs.svg" />
</figure>

## `fatfsgen.py`

`fatfsgen.py <fatfs/fatfsgen.py>` generates FAT file systems on the host.
...
There exist two scripts for that purpose, `fatfsgen.py <fatfs/fatfsgen.py>` and `wl_fatfsgen.py <fatfs/wl_fatfsgen.py>`. The difference is that `wl_fatfsgen.py` firstly uses `fatfsgen.py` for generating the partition and then initializes wear leveling.
...
The entry denotes the file with 8.3 file name ("FILENAME.EXT") \_\_(0x00/00-0A)\_\_ of size 0x1E = 30 bytes \_\_(0x10/0x0C)\_\_, with default times of modification and creation (0x0021) \_\_(0x10/00,02 and 08)\_\_. The relevant cluster for the file is located at \_\_0x02 (0x10/0A)\_\_. Please notice that a character is encoded using one byte (e.g., \_\_0x46 == 'F'\_\_)
...
- `storage/fatfs/fatfsgen` demonstrates how to use the FatFS partition generation tool to automatically create a FatFS image from a host folder during the building process.
