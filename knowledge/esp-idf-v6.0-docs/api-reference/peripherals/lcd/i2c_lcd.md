<!-- Source: _sources/api-reference/peripherals/lcd/i2c_lcd.rst.txt (ESP-IDF v6.0 documentation) -->

# I2C Interfaced LCD

1.  Create I2C bus. Please refer to `I2C API doc </api-reference/peripherals/i2c>` for more details.
