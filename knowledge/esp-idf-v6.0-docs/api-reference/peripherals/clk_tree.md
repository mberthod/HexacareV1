<!-- Source: _sources/api-reference/peripherals/clk_tree.rst.txt (ESP-IDF v6.0 documentation) -->
...
{IDF_TARGET_NAME}'s root clocks are listed in `soc_root_clk_t`:
...
>   >
>   > >   >
>   > not SOC_CLK_RC_FAST_D256_SUPPORTED and SOC_CLK_RC_FAST_SUPPORT_CALIBRATION
>   >
...
inc/clk_tree_defs.inc

inc/esp_clk_tree.inc
