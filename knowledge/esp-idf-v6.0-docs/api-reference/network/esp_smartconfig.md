<!-- Source: _sources/api-reference/network/esp_smartconfig.rst.txt (ESP-IDF v6.0 documentation) -->
...
If you are looking for other options to provision your {IDF_TARGET_NAME} devices, check `../provisioning/index`.

## Application Example

Connect {IDF_TARGET_NAME} to the target AP using SmartConfig: `wifi/smart_config`.
