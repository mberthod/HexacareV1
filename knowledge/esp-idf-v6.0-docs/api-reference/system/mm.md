<!-- Source: _sources/api-reference/system/mm.rst.txt (ESP-IDF v6.0 documentation) -->
...
<!-- Only for: esp32s2 -->
4 MB external memory addresses (from 0x40400000 to 0x40800000) which have the `MMU_MEM_CAP_EXEC` and `MMU_MEM_CAP_READ` capabilities are not available for users to allocate, due to hardware limitations.
...
<img src="/../_static/diagrams/mmu/mem_pool.png" class="align-center" alt="image" />
...
- Enclosed: block A is completely enclosed within block B, see figure below:
  ...
  <img src="/../_static/diagrams/mmu/enclosed.png" class="align-center" alt="image" />

- Identical: block A is completely the same as block B, see figure below:

  <img src="/../_static/diagrams/mmu/identical.png" class="align-center" alt="image" />
...
- Overlapped: block A is overlapped with block B, see figure below:
  ...
  <img src="/../_static/diagrams/mmu/overlapped.png" class="align-center" alt="image" />

  There is a special condition, when block A entirely encloses block B, see figure below:

  <img src="/../_static/diagrams/mmu/inversed_enclosed.png" class="align-center" alt="image" />
...
SOC_PSRAM_DMA_CAPABLE and not esp32s2
...
See `/api-reference/system/mm_sync` for more details.
