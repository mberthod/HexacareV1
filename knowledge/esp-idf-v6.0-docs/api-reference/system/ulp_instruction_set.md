<!-- Source: _sources/api-reference/system/ulp_instruction_set.rst.txt (ESP-IDF v6.0 documentation) -->
...
Note that the offset specified in bytes is converted to a 32-bit word offset before execution. See the section `ulp-fsm-addressing` for more details.
