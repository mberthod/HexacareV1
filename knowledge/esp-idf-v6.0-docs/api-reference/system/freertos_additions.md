<!-- Source: _sources/api-reference/system/freertos_additions.rst.txt (ESP-IDF v6.0 documentation) -->
...
../../../\_static/diagrams/ring-buffer/ring_buffer_send_non_byte_buf.diag
...
../../../\_static/diagrams/ring-buffer/ring_buffer_send_byte_buf.diag
...
../../../\_static/diagrams/ring-buffer/ring_buffer_send_acquire_complete.diag
...
../../../\_static/diagrams/ring-buffer/ring_buffer_wrap_no_split.diag
...
../../../\_static/diagrams/ring-buffer/ring_buffer_wrap_allow_split.diag
...
../../../\_static/diagrams/ring-buffer/ring_buffer_read_ret_non_byte_buf.diag
...
../../../\_static/diagrams/ring-buffer/ring_buffer_read_ret_byte_buf.diag
...
The tick interrupt stays active while the cache is disabled, therefore any tick hook (FreeRTOS or ESP-IDF) functions must be placed in internal RAM. Please refer to the `SPI flash API documentation <iram-safe-interrupt-handlers>` for more details.
...
- Calling the Vanilla FreeRTOS function `vTaskSetThreadLocalStoragePointer` simply sets the TLSP's associated Deletion Callback to <span class="title-ref">NULL</span>, meaning that no callback is called for that TLSP during task deletion.
...
- <span class="title-ref">ORIG_INCLUDE_PATH</span> - contains an absolute path to freertos root include folder. Thus instead of <span class="title-ref">\#include "freertos/FreeRTOS.h"</span> you can refer to headers directly: <span class="title-ref">\#include "FreeRTOS.h"</span>.
...
inc/esp_freertos_hooks.inc

### Additional API

inc/idf_additions.inc
