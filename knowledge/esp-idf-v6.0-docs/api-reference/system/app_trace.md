<!-- Source: _sources/api-reference/system/app_trace.rst.txt (ESP-IDF v6.0 documentation) -->
...
3.  System behaviour analysis, see `app_trace-system-behaviour-analysis-with-segger-systemview`.
