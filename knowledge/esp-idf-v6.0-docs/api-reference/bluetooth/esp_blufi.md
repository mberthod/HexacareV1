<!-- Source: _sources/api-reference/bluetooth/esp_blufi.rst.txt (ESP-IDF v6.0 documentation) -->
...
- `bluetooth/blufi` how to use the Blufi function to configure the Wi-Fi connection to an AP via a Bluetooth channel on {IDF_TARGET_NAME}.

## API Reference

inc/esp_blufi_api.inc
