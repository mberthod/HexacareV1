...
<figure>
<img src="../../../../_static/esp32_nimble_stack.png" class="align-center" alt="../../../../_static/esp32_nimble_stack.png" />
<figcaption>ESP NimBLE Stack</figcaption>
</figure>
...
To begin with, make sure that the NimBLE stack is enabled from menuconfig `choose NimBLE for the Bluetooth host <CONFIG_BT_HOST>`.
...
This documentation does not cover NimBLE APIs. Refer to [NimBLE tutorial](https://mynewt.apache.org/latest/network/index.html#ble-user-guide) for more details on the programming sequence/NimBLE APIs for different scenarios.

## API Reference

inc/esp_nimble_hci.inc
