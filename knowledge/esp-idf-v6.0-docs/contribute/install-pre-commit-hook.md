<!-- Source: _sources/contribute/install-pre-commit-hook.rst.txt (ESP-IDF v6.0 documentation) -->
...
For detailed usage, please refer to the documentation of [pre-commit](https://pre-commit.com/).
