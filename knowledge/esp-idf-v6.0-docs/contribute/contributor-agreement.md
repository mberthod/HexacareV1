<!-- Source: _sources/contribute/contributor-agreement.rst.txt (ESP-IDF v6.0 documentation) -->
...
The purpose of this contributor agreement ("Agreement") is to clarify and document the rights granted by contributors to Us. To make this document effective, please follow the instructions in the `index`.
