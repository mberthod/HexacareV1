<!-- Source: _sources/api-guides/kconfig/project-configuration-guide.rst.txt (ESP-IDF v6.0 documentation) -->
...
After successful [installation](https://github.com/espressif/vscode-esp-idf-extension/blob/master/docs/tutorial/install.md) of the ESP-IDF plugin for Visual Studio Code, follow their [Basic Use document](https://github.com/espressif/vscode-esp-idf-extension/blob/master/docs/tutorial/basic_use.md) and search for the **Configuration Editor** option.

### Configuration with ESP-IDE

We also provide [plugin for Eclipse IDE](https://github.com/espressif/idf-eclipse-plugin/blob/master/README.md#Installation). To edit the project configuration, follow [our documentation about SDK configuration](https://github.com/espressif/idf-eclipse-plugin/blob/master/README.md#sdk-configuration-editor)
