<!-- Source: _sources/api-guides/low-power-mode/low-power-mode-wifi.rst.txt (ESP-IDF v6.0 documentation) -->
...
The Deep-sleep mode in Wi-Fi scenarios is essentially the same as in a pure system. For details, please refer to `Deep-sleep Mode`. Here, it will not be further discussed.
