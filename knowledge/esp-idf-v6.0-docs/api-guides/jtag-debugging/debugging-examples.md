<!-- Source: _sources/api-guides/jtag-debugging/debugging-examples.rst.txt (ESP-IDF v6.0 documentation) -->

# Debugging Examples

This section describes debugging with GDB from `jtag-debugging-examples-eclipse` as well as from `jtag-debugging-examples-command-line`.

## Eclipse

Verify if your target is ready and loaded with `get-started/blink` example. Configure and start debugger following steps in section `jtag-debugging-using-debugger-eclipse`. Pick up where target was left by debugger, i.e., having the application halted at breakpoint established at `app_main()`.
...
<figure>
<img src="../../../_static/debugging-target-halted.jpg" class="align-center" alt="../../../_static/debugging-target-halted.jpg" />
<figcaption>Target halted during debugging</figcaption>
</figure>
...
<figure>
<img src="../../../_static/debugging-navigate-through-the-stack.jpg" class="align-center" alt="../../../_static/debugging-navigate-through-the-stack.jpg" />
<figcaption>Navigate through the call stack</figcaption>
</figure>
...
<figure>
<img src="../../../_static/debugging-setting-breakpoint.jpg" class="align-center" alt="../../../_static/debugging-setting-breakpoint.jpg" />
<figcaption>Setting a breakpoint</figcaption>
</figure>

Information how many breakpoints are set and where is shown in window "Breakpoints" on top right. Click "Show Breakpoints Supported by Selected Target" to refresh this list. Besides the two just set breakpoints the list may contain temporary breakpoint at function `app_main()` established at debugger start. As maximum two breakpoints are allowed (see `jtag-debugging-tip-breakpoints`), you need to delete it, or debugging will fail.

<figure>
<img src="../../../_static/debugging-three-breakpoints-set.jpg" class="align-center" alt="../../../_static/debugging-three-breakpoints-set.jpg" />
<figcaption>Three breakpoints are set / maximum two are allowed</figcaption>
</figure>
...
Read more about breakpoints under `jtag-debugging-tip-breakpoints` and `jtag-debugging-tip-where-breakpoints`
...
<figure>
<img src="../../../_static/debugging-target-halted-manually.jpg" class="align-center" alt="../../../_static/debugging-target-halted-manually.jpg" />
<figcaption>Target halted manually</figcaption>
</figure>
...
<figure>
<img src="../../../_static/debugging-step-over.jpg" class="align-center" alt="../../../_static/debugging-step-over.jpg" />
<figcaption>Stepping through the code with "Step Over (F6)"</figcaption>
</figure>

If you press "Step Into (F5)" instead, then debugger will step inside subroutine calls.

<figure>
<img src="../../../_static/debugging-step-into.jpg" class="align-center" alt="../../../_static/debugging-step-into.jpg" />
<figcaption>Stepping through the code with "Step Into (F5)"</figcaption>
</figure>

In this particular case debugger stepped inside `gpio_set_level(BLINK_GPIO, 0)` and effectively moved to `gpio.c` driver code.

See `jtag-debugging-tip-why-next-works-as-step` for potential limitation of using `next` command.
...
For more information, see *{IDF_TARGET_NAME} Technical Reference Manual* \> *IO MUX and GPIO Matrix (GPIO, IO_MUX)* \[[PDF](%7BIDF_TARGET_TRM_EN_URL%7D#iomuxgpio)\].
...
<figure>
<img src="../../../_static/debugging-memory-location-on.jpg" class="align-center" alt="../../../_static/debugging-memory-location-on.jpg" />
<figcaption>Observing memory location 0x3FF44004 changing one bit to "ON"</figcaption>
</figure>
...
<figure>
<img src="../../../_static/debugging-memory-location-off.jpg" class="align-center" alt="../../../_static/debugging-memory-location-off.jpg" />
<figcaption>Observing memory location 0x3FF44004 changing one bit to "OFF"</figcaption>
</figure>
...
<figure>
<img src="../../../_static/debugging-watch-variable.jpg" class="align-center" alt="../../../_static/debugging-watch-variable.jpg" />
<figcaption>Watching program variable "i"</figcaption>
</figure>
...
<figure>
<img src="../../../_static/debugging-setting-conditional-breakpoint.jpg" class="align-center" alt="../../../_static/debugging-setting-conditional-breakpoint.jpg" />
<figcaption>Setting a conditional breakpoint</figcaption>
</figure>
...
Verify if your target is ready and loaded with `get-started/blink` example. Configure and start debugger following steps in section `jtag-debugging-using-debugger-command-line`. Pick up where target was left by debugger, i.e. having the application halted at breakpoint established at `app_main()`:
...
1.  `jtag-debugging-examples-command-line-01`
2.  `jtag-debugging-examples-command-line-02`
3.  `jtag-debugging-examples-command-line-03`
4.  `jtag-debugging-examples-command-line-04`
5.  `jtag-debugging-examples-command-line-05`
6.  `jtag-debugging-examples-command-line-06`
7.  `jtag-debugging-examples-command-line-07`
8.  `jtag-debugging-examples-command-line-08`
...
You may have up to two watchpoints, see `jtag-debugging-tip-breakpoints`.
...
Users that need to use the FreeRTOS task interactions can use the GDB `freertos` command. The `freertos` command is not native to GDB and comes from the [freertos-gdb](https://pypi.org/project/freertos-gdb) Python extension module. The `freertos` command contains a series of sub-commands as demonstrated in the code snippet:
