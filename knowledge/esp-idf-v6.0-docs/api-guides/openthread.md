<!-- Source: _sources/api-guides/openthread.rst.txt (ESP-IDF v6.0 documentation) -->

# OpenThread

[OpenThread](https://github.com/openthread/openthread) is an IP stack running on the 802.15.4 MAC layer which features mesh network and low power consumption.
