<!-- Source: _sources/about.rst.txt (ESP-IDF v6.0 documentation) -->

# About

<!-- Only for: esp32 -->
This is documentation of [ESP-IDF](https://github.com/espressif/esp-idf), the framework to develop applications for [{IDF_TARGET_NAME}](https://www.espressif.com/en/products/socs/esp32) chip by [Espressif](https://espressif.com).
...
<!-- Only for: esp32s2 -->
This is documentation of [ESP-IDF](https://github.com/espressif/esp-idf), the framework to develop applications for {IDF_TARGET_NAME}.
...
<figure>
<img src="../_static/about-doc.png" class="align-center" alt="../_static/about-doc.png" />
<figcaption>Espressif IoT Integrated Development Framework</figcaption>
</figure>
