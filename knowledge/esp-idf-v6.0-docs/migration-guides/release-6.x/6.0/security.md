<!-- Source: _sources/migration-guides/release-6.x/6.0/security.rst.txt (ESP-IDF v6.0 documentation) -->
...
In ESP-IDF v6.0, multiple ESP-IDF components have been migrated from using legacy Mbed TLS cryptography APIs (for example, `mbedtls_sha*_*()`, `mbedtls_md*_*()`, etc.) to using the [PSA Crypto API](https://arm-software.github.io/psa-api/).
...
- `Mbed TLS 4.0 migration guide <components/mbedtls/mbedtls/docs/4.0-migration-guide.md>`
- `TF-PSA-Crypto 1.0 migration guide <components/mbedtls/mbedtls/tf-psa-crypto/docs/1.0-migration-guide.md>`
- `TF-PSA-Crypto PSA transition notes <components/mbedtls/mbedtls/tf-psa-crypto/docs/psa-transition.md>`
