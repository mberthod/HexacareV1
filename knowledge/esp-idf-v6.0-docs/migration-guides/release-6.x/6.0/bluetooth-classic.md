<!-- Source: _sources/migration-guides/release-6.x/6.0/bluetooth-classic.rst.txt (ESP-IDF v6.0 documentation) -->
...
>
> > - `/bt/host/bluedroid/api/include/api/esp_gap_bt_api.h`
> >
