<!-- Source: _sources/migration-guides/release-6.x/6.0/protocols.rst.txt (ESP-IDF v6.0 documentation) -->
...
2.  **Option B - Use Custom Stack API**
    ...
    For detailed documentation on implementing a custom TLS stack, see `esp_tls_custom_stack`.
