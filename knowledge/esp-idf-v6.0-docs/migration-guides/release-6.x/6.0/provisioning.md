<!-- Source: _sources/migration-guides/release-6.x/6.0/provisioning.rst.txt (ESP-IDF v6.0 documentation) -->
...
- [network_provisioning component](https://components.espressif.com/component/espressif/network_provisioning)
...
- `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_0` now defaults to `n` (previously `y`)
- `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_1` now defaults to `n` (previously `y`)
...
- For security version 0: Enable `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_0`
- For security version 1: Enable `CONFIG_ESP_PROTOCOMM_SUPPORT_SECURITY_VERSION_1`
