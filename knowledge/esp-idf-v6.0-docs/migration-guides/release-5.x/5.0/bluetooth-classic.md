<!-- Source: _sources/migration-guides/release-5.x/5.0/bluetooth-classic.rst.txt (ESP-IDF v6.0 documentation) -->
...
>
> - `bt/host/bluedroid/api/include/api/esp_hf_ag_api.h`
>
...
>   >
>   >   > Along with this change, the <span class="title-ref">bt_bdaddr_t init</span> and <span class="title-ref">bt_bdaddr_t deinit</span> has been removed from <span class="title-ref">union btc_arg_t</span>.
>   >
