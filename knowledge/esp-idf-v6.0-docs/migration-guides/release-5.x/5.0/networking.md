<!-- Source: _sources/migration-guides/release-5.x/5.0/networking.rst.txt (ESP-IDF v6.0 documentation) -->
...
The TCP/IP Adapter was a network interface abstraction component used in ESP-IDF prior to v4.1. This section outlines migration from `tcpip_adapter` API to its successor `/api-reference/network/esp_netif`.

### Updating Network Connection Code

#### Network Stack Initialization

- You may simply replace `tcpip_adapter_init()` with `esp_netif_init()`. However, please should note that the `esp_netif_init()` function now returns standard error codes. See `/api-reference/network/esp_netif` for more details.
...
- `Setters/Getters <esp_netif/include/esp_netif.h#L241>`
- `DHCP <esp_netif/include/esp_netif.h#L387>`
- `DNS <esp_netif/include/esp_netif.h#L516>`
- `IP address <esp_netif/include/esp_netif.h#L568>`
...
- `esp-netif IP address definitions <esp_netif/include/esp_netif_ip_addr.h#L96>`
