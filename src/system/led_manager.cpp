        ...
        if (now < s_flash_end_time) {
            ...
            switch (s_current_state) {
                case LED_STATE_SCANNING:
                    ...
                    if ((counter % 4) < 2) color = s_pixel.Color(0, 0, 255);
                    break;
                ...
                case LED_STATE_OTA:
                    ...
                    if ((counter % 2) == 0) color = s_pixel.Color(255, 165, 0);
                    break;
                case LED_STATE_OTA_SERIAL:
                    // OTA Série (0x01) : Violet pulsé = mise à jour ROOT par câble
                    if ((counter % 6) < 3) color = s_pixel.Color(180, 0, 255);
                ...
                case LED_STATE_ORPHAN:
                    ...
                    if ((counter % 4) < 2) color = s_pixel.Color(255, 100, 0);
                    else color = s_pixel.Color(255, 0, 0);
                    break;
